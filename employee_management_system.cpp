...
cin>>password;
    ...
    Sleep(2000); //For 3 seconds pause in system;
        system("CLS");
}
};

class Employee_Details{ // It is also a abstract base class; 
public:
struct emp{
...
class Login_User :virtual public Employee_manage, public Employee_Details{
protected:
...
cout<<"\n\t\tEmployee Management System"<<endl;
    ...
    Sleep(2000);  // 3000 means 3 seconds;
        system("CLS");
